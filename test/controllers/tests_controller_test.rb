...
class TestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create test" do
    assert_difference('Test.count') do
      post tests_url, params: { test: { diag: @test.diag, name: @test.name, photo: @test.photo } }
    end
  ...
  test "should update test" do
    patch test_url(@test), params: { test: { diag: @test.diag, name: @test.name, photo: @test.photo } }
